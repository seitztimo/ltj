...
urlpatterns = [
    ...
    url(r'^observationseries-report/(?P<pk>\d+)/$', views.ObservationSeriesReportView.as_view(),
        name='observationseries-report'),
    url(r'^feature-observations-report/(?P<pk>\d+)/$', views.FeatureObservationsReportView.as_view(),
        name='feature-observations-report'),
    url(r'^feature-habitattypeobservations-report/(?P<pk>\d+)/$',
