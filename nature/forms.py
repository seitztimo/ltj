...
class ProtectionInlineForm(forms.ModelForm):
    ...
    conservation_programmes = forms.ModelMultipleChoiceField(
        ...
        widget=FilteredSelectMultiple(
            verbose_name=_("Conservation programmes"), is_stacked=False
        ),
        required=False,
    )
    ...
    def _save_m2m(self):
        ...
        ProtectionConservationProgramme.objects.filter(
            protection=self.instance
        ).delete()
        ...
        ProtectionConservationProgramme.objects.bulk_create(
            protection_conservation_programmes
        )
