# -*- coding: utf-8 -*-
# Generated by Django 1.11.4 on 2017-10-26 15:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('link', models.CharField(blank=True, db_column='linkki', max_length=4000, null=True)),
                ('protection_level', models.ForeignKey(db_column='suojaustasoid', on_delete=django.db.models.deletion.PROTECT, to='nature.ProtectionLevel')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(db_column='suojaustasoid', on_delete=django.db.models.deletion.PROTECT, to='nature.ProtectionLevel'),
        ),
        migrations.AddField(
            model_name='observation',
            name='series',
