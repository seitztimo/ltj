...
class File(models.Model):
    ...
    uploaded_by = models.ForeignKey(settings.AUTH_USER_MODEL, verbose_name=_('uploaded by'),
                                    related_name='uploaded_files', on_delete=models.SET_NULL, null=True)
    uploaded_time = models.DateTimeField(_('uploaded time'), auto_now_add=True, null=True, blank=True)
    last_modified_by = models.ForeignKey(settings.AUTH_USER_MODEL, verbose_name=_('last modified by'),
                                         related_name='modified_files', on_delete=models.SET_NULL, null=True)
